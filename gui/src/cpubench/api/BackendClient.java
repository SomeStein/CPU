...
public final class BackendClient {
    ...
    public Process startRunProfileFile(Path profilePath) throws IOException {
        ProcessBuilder builder = new ProcessBuilder(command("run-profile-file", profilePath.toString()));
        builder.directory(repoRoot.toFile());
        builder.redirectErrorStream(true);
        return builder.start();
    }
