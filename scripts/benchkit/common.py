...
BENCHMARK_JAVA_SOURCE_ROOTS = (BENCHMARK_JAVA_DIR, BENCHMARK_JAVA_SRC_DIR)
...
TOOLS_MANIFESTS_DIR = TOOLS_DIR / "manifests"
TOOLS_TOOLCHAINS_DIR = TOOLS_DIR / "toolchains"
TOOLS_INSTALLED_STATE_PATH = TOOLS_DIR / "installed-state.json"
